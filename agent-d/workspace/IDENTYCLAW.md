...
After rotate/activate, scripts print `RESTART_REQUIRED` — ask the operator to run `./identyclaw.sh restart /home/dedalo47/identyclaw-agents-app/agents/agent-d` (or `./identyclaw.sh near-activate /home/dedalo47/identyclaw-agents-app/agents/agent-d`). Never paste private keys into chat.
